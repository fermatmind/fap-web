# EN Personality Opportunity Audit
...
No new MBTI type×type, personality×career/problem, Big Five combinations or “official 32 types,” Enneagram wing×instinct matrix, Tritype, cross-framework combinations, or recommendation pSEO. See `en_personality_opportunities.csv` for row-level decisions.
