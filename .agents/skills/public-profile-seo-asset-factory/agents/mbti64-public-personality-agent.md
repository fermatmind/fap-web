# MBTI64 Public Personality Agent
...
- Backend CMS/API is the content authority.
- fap-web may render CMS/API output and run SEO/readiness gates.
- Result pages, paid reports, score payloads, and private report modules are not public content sources.
...
- URL inventory and exact exposure audit.
- Trademark and method boundary gate.
