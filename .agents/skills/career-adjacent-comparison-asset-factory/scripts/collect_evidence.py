        ...
        for locale in ("zh-CN", "en"):
            ...
            for i, cand in enumerate(adjacent, 1):
                evidence_items.append({
                    ...
                    "shared_work_basis": cand["shared_work_basis"],
                    "shared_skill_basis": cand["shared_skill_basis"],
                    "shared_terms": cand["shared_terms"],
                    "key_difference": cand["key_difference"],
                    "transfer_boundary": cand["transfer_boundary"],
                    "evidence_confidence": cand["evidence_confidence"],
                    "source_basis": cand["source_basis"],
                    "rejected_proxy_notes": cand["rejected_proxy_notes"],
                    "boundary": "Adjacency requires both work-activity and skill overlap; title, salary, AI impact, broad family, and personality similarity are not accepted as proof.",
                })
            row = {
                ...
                "facts": {
                    ...
                    "shared_work_basis": [e["shared_work_basis"] for e in evidence_items],
                    "shared_skill_basis": [e["shared_skill_basis"] for e in evidence_items],
                    "relationship_types": [e["relationship_type"] for e in evidence_items],
                    "evidence_confidence": [e["evidence_confidence"] for e in evidence_items],
                    ...
                    "rejected_proxy_notes": [
                        "Rejected title similarity, salary similarity, broad-family-only similarity, AI-impact similarity, personality-fit similarity, job-board recommendations, and slug similarity as adjacency proof."
                    ],
                },
