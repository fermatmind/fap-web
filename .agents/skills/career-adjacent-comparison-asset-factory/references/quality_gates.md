# Career Adjacent Comparison Quality Gates

Adjacent comparison must explain actual occupational proximity and transfer cost. It is not a title-similarity or salary-similarity feature.
...
- Locale copy is market-specific and avoids invented local credential claims.
...
Sample manager/specialist pairs, technician/operator pairs, regulated roles, creative roles, healthcare roles, and software/engineering roles. These often look adjacent by title while differing materially in responsibility.
