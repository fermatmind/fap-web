#!/usr/bin/env python3
"""Freeze a PASS career-skills-entry baseline with SHA manifests."""
...
from skills_entry_common import read_jsonl, sha256_file, write_json
...
def main() -> int:
    ...
    validation = {
        "generated_at": now,
        "final_conclusion": "CAREER_SKILLS_ENTRY_BASELINE_FROZEN",
    ...
    (output / "baseline_freeze_report.md").write_text(
        "# Career Skills Entry Baseline Freeze\n\n"
        "- final_conclusion: `CAREER_SKILLS_ENTRY_BASELINE_FROZEN`\n"
