#!/usr/bin/env python3
"""Create a career-skills-entry batch manifest from the canonical seed."""
...
from skills_entry_common import LOCALES, load_seed, normalize_seed_row, write_csv, write_json


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--seed", required=True, help="Canonical 1046 career seed JSON.")
    parser.add_argument("--batch-index", type=int, required=True, help="Skills-entry batch index.")
...
def main() -> int:
            ...
            rows.append(
                {
                    ...
                    "requires_work_activities_block": True,
                }
            )
    ...
    fields = [
        ...
        "requires_work_activities_block",
    ]
