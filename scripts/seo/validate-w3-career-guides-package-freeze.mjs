...
try {
  ...
  const acceptedQaPass = guides.status === "qa_pass" && guides.package_sha256 === manifest.package_sha256 && guides.qa_report_ref === "generated/en-content-parity/W9-independent-qa/career-guides/w3-career-guides-0b6728c9/independent_qa_report.json" && guides.gate_lineage.length === 2 && guides.gate_lineage[0].status === "package_frozen" && guides.gate_lineage[0].evidence_owner_lane_id === "W3" && guides.gate_lineage[0].report_ref === "generated/en-content-parity/W3-editorial-cms/career-guides/editorial_review.json" && guides.gate_lineage[0].report_sha256 === candidate.gate_evidence.report_sha256 && guides.gate_lineage[0].package_sha256 === manifest.package_sha256 && guides.gate_lineage[1].status === "qa_pass" && guides.gate_lineage[1].evidence_owner_lane_id === "W9" && guides.gate_lineage[1].report_ref === guides.qa_report_ref && guides.gate_lineage[1].report_sha256 === "1846b40cc42ebfb202f8e0cd013dfdee1519fdd850d59cb5a56a3069ac1d0815" && guides.gate_lineage[1].package_sha256 === manifest.package_sha256;
  assert(preAcceptance || acceptedFreeze || acceptedQaPass, "Master must retain the pre-acceptance, exact frozen, or exact independent W9 qa_pass state");
