...
try {
  ...
  const acceptedQaPass = careerGuides.status === "qa_pass" && careerGuides.package_sha256 === "0b6728c9a07e9404d0de57698f0f8b59616358ba91e456d1be848a1fe167ca7c" && careerGuides.qa_report_ref === "generated/en-content-parity/W9-independent-qa/career-guides/w3-career-guides-0b6728c9/independent_qa_report.json" && careerGuides.gate_lineage.length === 2 && careerGuides.gate_lineage[0].status === "package_frozen" && careerGuides.gate_lineage[0].evidence_owner_lane_id === "W3" && careerGuides.gate_lineage[0].report_ref === "generated/en-content-parity/W3-editorial-cms/career-guides/editorial_review.json" && careerGuides.gate_lineage[0].report_sha256 === "137c719a434aa795c41332d89bdd4c10b5e6f2879b4ed5f98a5d0ebcb69fe402" && careerGuides.gate_lineage[0].package_sha256 === careerGuides.package_sha256 && careerGuides.gate_lineage[1].status === "qa_pass" && careerGuides.gate_lineage[1].evidence_owner_lane_id === "W9" && careerGuides.gate_lineage[1].report_ref === careerGuides.qa_report_ref && careerGuides.gate_lineage[1].report_sha256 === "1846b40cc42ebfb202f8e0cd013dfdee1519fdd850d59cb5a56a3069ac1d0815" && careerGuides.gate_lineage[1].package_sha256 === careerGuides.package_sha256;
  assert(preAcceptance || acceptedFreeze || acceptedQaPass, "Master Career Guides must retain the pre-acceptance, exact frozen, or exact independent W9 qa_pass state");
