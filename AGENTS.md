...
- CMS draft import and publication are covered by the concrete end-to-end content `/goal` after QA and dry-run gates pass. Production deployment, database migration, secrets or permission changes, destructive operations, sitemap/llms/indexability, and Search Channel submission remain separately controlled actions.
