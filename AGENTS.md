...
- The V2 master is deterministically materialized from lane-local manifests and trusted backend receipts. Producer and QA work must not edit it directly, and unrelated lane or global-master changes must not invalidate an unchanged lane-local package SHA.
