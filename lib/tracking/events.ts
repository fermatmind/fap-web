...
const EVENT_FIELD_WHITELIST: Record<TrackingEventName, readonly string[]> = {
  ...
  view_result: ["attemptIdMasked", "locked", "typeCode", "identity", "variantKey", "variantKeys", "packId", "engineVersion", "locale"],
  revisit_result: ["attemptIdMasked", "locked", "typeCode", "identity", "variantKey", "variantKeys", "packId", "engineVersion", "locale"],
  share_result: ["attemptIdMasked", "typeCode", "identity", "variantKey", "variantKeys", "packId", "engineVersion", "shareMethod", "locale"],
  view_paywall: ["attemptIdMasked", "sku", "priceShown", "locale"],
  click_unlock: ["attemptIdMasked", "sku", "priceShown", "typeCode", "identity", "variantKey", "variantKeys", "packId", "engineVersion", "locale"],
  create_order: ["attemptIdMasked", "orderNoMasked", "sku", "typeCode", "identity", "variantKey", "variantKeys", "packId", "engineVersion", "locale"],
  ...
  ui_card_impression: ["slug", "scale_code", "visual_kind", "sectionKey", "variantKey", "variantKeys", "overviewVariantKey", "typeCode", "identity", "packId", "engineVersion", "locale"],
  ui_card_interaction: ["slug", "scale_code", "visual_kind", "interaction", "sectionKey", "variantKey", "variantKeys", "overviewVariantKey", "typeCode", "identity", "packId", "engineVersion", "locale"],
