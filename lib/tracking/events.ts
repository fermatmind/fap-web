...
const EVENT_FIELD_WHITELIST: Record<TrackingEventName, readonly string[]> = {
  ...
  start_attempt: ["slug", "test_slug", "scaleCode", "attemptIdMasked", "form_code", "entry_surface", "source_page_type", "target_action", "locale"],
  ...
  landing_view: ["slug", "test_slug", "form_code", "entry_surface", "source_page_type", "target_action", "locale", ...COMMON_BIG5_FIELDS],
  start_click: ["slug", "test_slug", "form_code", "entry_surface", "source_page_type", "target_action", "locale", "disclaimer_version", "disclaimer_hash", ...COMMON_BIG5_FIELDS],
