...
const EVENT_FIELD_WHITELIST: Record<TrackingEventName, readonly string[]> = {
  ...
  view_result: ["attemptIdMasked", "attempt_id", "locked", "typeCode", "identity", "variantKey", "variantKeys", "sceneFingerprint", "boundaryFlags", "axisBands", "packId", "engineVersion", "userState", "primaryFocusKey", "secondaryFocusKeys", "orderedSectionKeys", "ctaPriorityKeys", "locale"],
  revisit_result: ["attemptIdMasked", "attempt_id", "locked", "typeCode", "identity", "variantKey", "variantKeys", "sceneFingerprint", "boundaryFlags", "axisBands", "packId", "engineVersion", "userState", "primaryFocusKey", "secondaryFocusKeys", "orderedSectionKeys", "ctaPriorityKeys", "locale"],
  share_result: ["attemptIdMasked", "attempt_id", "typeCode", "identity", "variantKey", "variantKeys", "sceneFingerprint", "boundaryFlags", "axisBands", "packId", "engineVersion", "userState", "primaryFocusKey", "secondaryFocusKeys", "orderedSectionKeys", "ctaPriorityKeys", "shareMethod", "ctaKey", "ctaRank", "locale"],
  accuracy_feedback: ["attempt_id", "feedback", "sectionKey", "actionKey", "contrastKey", "neighborTypeKeys", "closeCallAxes", "typeCode", "identity", "variantKeys", "sceneFingerprint", "boundaryFlags", "axisBands", "packId", "engineVersion", "userState", "primaryFocusKey", "secondaryFocusKeys", "orderedSectionKeys", "ctaPriorityKeys", "displayOrder", "isPrimaryFocus", "locale"],
  view_paywall: ["attemptIdMasked", "sku", "priceShown", "locale"],
  click_unlock: ["attemptIdMasked", "attempt_id", "sku", "priceShown", "typeCode", "identity", "variantKey", "variantKeys", "sceneFingerprint", "boundaryFlags", "axisBands", "packId", "engineVersion", "userState", "primaryFocusKey", "secondaryFocusKeys", "orderedSectionKeys", "ctaPriorityKeys", "ctaKey", "ctaRank", "locale"],
  create_order: ["attemptIdMasked", "attempt_id", "orderNoMasked", "sku", "typeCode", "identity", "variantKey", "variantKeys", "sceneFingerprint", "boundaryFlags", "axisBands", "packId", "engineVersion", "userState", "primaryFocusKey", "secondaryFocusKeys", "orderedSectionKeys", "ctaPriorityKeys", "ctaKey", "ctaRank", "locale"],
  ...
  ui_card_impression: ["slug", "scale_code", "visual_kind", "attempt_id", "sectionKey", "sceneKey", "styleKey", "actionKey", "variantKey", "contrastKey", "neighborTypeKeys", "closeCallAxes", "variantKeys", "sceneFingerprint", "boundaryFlags", "axisBands", "overviewVariantKey", "typeCode", "identity", "packId", "engineVersion", "userState", "primaryFocusKey", "secondaryFocusKeys", "orderedSectionKeys", "ctaPriorityKeys", "displayOrder", "isPrimaryFocus", "ctaKey", "ctaRank", "locale"],
  ui_card_interaction: ["slug", "scale_code", "visual_kind", "interaction", "attempt_id", "sectionKey", "sceneKey", "styleKey", "actionKey", "variantKey", "contrastKey", "neighborTypeKeys", "closeCallAxes", "variantKeys", "sceneFingerprint", "boundaryFlags", "axisBands", "overviewVariantKey", "typeCode", "identity", "packId", "engineVersion", "userState", "primaryFocusKey", "secondaryFocusKeys", "orderedSectionKeys", "ctaPriorityKeys", "displayOrder", "isPrimaryFocus", "ctaKey", "ctaRank", "locale"],
