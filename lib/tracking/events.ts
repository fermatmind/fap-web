...
const EVENT_FIELD_WHITELIST: Record<TrackingEventName, readonly string[]> = {
  ...
  start_attempt: ["slug", "test_slug", "scaleCode", "scale_code", "attemptIdMasked", "attempt_id", "form_code", "entry_surface", "source_page_type", "target_action", "landing_path", "locale", ...COMMON_BIG5_FIELDS, ...COMMON_SEO_CTA_ATTRIBUTION_FIELDS],
  submit_attempt: ["slug", "test_slug", "scale_code", "attemptIdMasked", "attempt_id", "answered_count", "durationMs", "duration_ms", "duration_bucket", "form_code", "locale", ...COMMON_BIG5_FIELDS, ...COMMON_SEO_CTA_ATTRIBUTION_FIELDS],
