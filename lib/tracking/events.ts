...
const EVENT_FIELD_WHITELIST: Record<TrackingEventName, readonly string[]> = {
  ...
  view_result: ["attemptIdMasked", "locked", "typeCode", "identity", "variantKey", "variantKeys", "sceneFingerprint", "boundaryFlags", "packId", "engineVersion", "locale"],
  revisit_result: ["attemptIdMasked", "locked", "typeCode", "identity", "variantKey", "variantKeys", "sceneFingerprint", "boundaryFlags", "packId", "engineVersion", "locale"],
  share_result: ["attemptIdMasked", "typeCode", "identity", "variantKey", "variantKeys", "sceneFingerprint", "boundaryFlags", "packId", "engineVersion", "shareMethod", "locale"],
  accuracy_feedback: ["feedback", "typeCode", "identity", "variantKeys", "sceneFingerprint", "boundaryFlags", "packId", "engineVersion", "locale"],
  view_paywall: ["attemptIdMasked", "sku", "priceShown", "locale"],
  click_unlock: ["attemptIdMasked", "sku", "priceShown", "typeCode", "identity", "variantKey", "variantKeys", "sceneFingerprint", "boundaryFlags", "packId", "engineVersion", "locale"],
  create_order: ["attemptIdMasked", "orderNoMasked", "sku", "typeCode", "identity", "variantKey", "variantKeys", "sceneFingerprint", "boundaryFlags", "packId", "engineVersion", "locale"],
  ...
  ui_card_impression: ["slug", "scale_code", "visual_kind", "sectionKey", "sceneKey", "styleKey", "variantKey", "variantKeys", "sceneFingerprint", "boundaryFlags", "overviewVariantKey", "typeCode", "identity", "packId", "engineVersion", "locale"],
  ui_card_interaction: ["slug", "scale_code", "visual_kind", "interaction", "sectionKey", "sceneKey", "styleKey", "variantKey", "variantKeys", "sceneFingerprint", "boundaryFlags", "overviewVariantKey", "typeCode", "identity", "packId", "engineVersion", "locale"],
