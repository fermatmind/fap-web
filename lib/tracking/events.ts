...
const EVENT_FIELD_WHITELIST: Record<TrackingEventName, readonly string[]> = {
  ...
  accuracy_feedback: ["feedback", "sectionKey", "contrastKey", "neighborTypeKeys", "closeCallAxes", "typeCode", "identity", "variantKeys", "sceneFingerprint", "boundaryFlags", "axisBands", "packId", "engineVersion", "locale"],
  ...
  ui_card_impression: ["slug", "scale_code", "visual_kind", "sectionKey", "sceneKey", "styleKey", "variantKey", "contrastKey", "neighborTypeKeys", "closeCallAxes", "variantKeys", "sceneFingerprint", "boundaryFlags", "axisBands", "overviewVariantKey", "typeCode", "identity", "packId", "engineVersion", "locale"],
  ui_card_interaction: ["slug", "scale_code", "visual_kind", "interaction", "sectionKey", "sceneKey", "styleKey", "variantKey", "contrastKey", "neighborTypeKeys", "closeCallAxes", "variantKeys", "sceneFingerprint", "boundaryFlags", "axisBands", "overviewVariantKey", "typeCode", "identity", "packId", "engineVersion", "locale"],
