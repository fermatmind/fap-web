...
export const CAREER_VISUAL_GROUPS: readonly CareerVisualGroupDefinition[] = [
  ...
  { id: "adjacent-comparison", label: "相邻职业与发展路径", componentIds: ["adjacent_career_comparison_table", "career_path_block", "related_next_pages"] },
  ...
  { id: "risk-change", label: "风险与变化", componentIds: ["career_risk_cards", "contract_project_risk_block", "next_steps_block"] },
  { id: "market-signals", label: "市场信号", componentIds: ["market_signal_card"] },
  { id: "faq-sources-boundaries", label: "常见问题与资料来源", componentIds: ["faq_block", "source_card", "review_validity_card", "boundary_notice", "final_cta"] },
] as const;
...
export const CAREER_FIELD_CONSUMPTION_LEDGER: readonly CareerFieldConsumption[] = [
  ...
  { componentId: "career_path_block", fieldPattern: "career_path_block*", visualGroupId: "adjacent-comparison" },
  ...
  { componentId: "related_next_pages", fieldPattern: "related_next_pages.*", visualGroupId: "adjacent-comparison" },
