...
export const CAREER_VISUAL_GROUPS: readonly CareerVisualGroupDefinition[] = [
  ...
  { id: "profile", label: "职业画像", componentIds: ["definition_block", "career_ai_description_block", "responsibilities_block", "work_context_block", "related_next_pages"] },
  { id: "ai-impact", label: "AI 影响", componentIds: ["ai_impact_table"] },
  { id: "china-reference", label: "中国大陆参考", componentIds: [] },
  { id: "bls-reference", label: "美国 BLS 数据", componentIds: ["career_snapshot_secondary_locale"] },
  ...
  { id: "faq-sources-boundaries", label: "FAQ、来源与边界", componentIds: ["faq_block", "source_card", "review_validity_card", "boundary_notice", "final_cta"] },
] as const;
...
export const CAREER_FIELD_CONSUMPTION_LEDGER: readonly CareerFieldConsumption[] = [
  ...
  { componentId: "presentation_v1", fieldPattern: "presentation_v1.hero.badges[*]", visualGroupId: "hero" },
  ...
  { componentId: "related_next_pages", fieldPattern: "related_next_pages.*", visualGroupId: "profile" },
