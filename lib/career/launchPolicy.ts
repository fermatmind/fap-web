...
export const CAREER_STABLE_ROUTES = [
  {
    key: "career_landing",
    route: "/career",
    authorityOwner: "frontend_career_center",
    rationale: "The focused Career center routes users to jobs, recommendations, and guides without owning backend career truth.",
  },
  {
  ...
  route_classes: [
    {
      ...
      notes: "Verify the localized Career center renders search plus jobs, recommendations, and guides paths without backend truth fallback.",
    },
    {
      key: "career_jobs_index",
      route: "/career/jobs",
