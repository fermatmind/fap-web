...
export const CAREER_STABLE_ROUTES = [
  {
    key: "career_landing",
    route: "/career",
    authorityOwner: "routing_config",
    rationale: "The retired Career landing permanently redirects to the backend-backed jobs directory.",
  },
  {
  ...
  route_classes: [
    {
      ...
      notes: "Verify a permanent locale-preserving redirect to /career/jobs and no sitemap exposure.",
    },
    {
      key: "career_jobs_index",
      route: "/career/jobs",
