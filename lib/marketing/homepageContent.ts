...
const HOME_PAGE_CONTENT: Record<Locale, HomeLocaleContent> = {
      ...
      items: [
        ...
        },
        {
          ...
          variants: [
            {
              title: "标准版",
              description: "快速确认当前情绪状态基线",
            },
            {
              title: "学术专业版",
              description: "用于更完整地观察抑郁与焦虑线索",
            },
          ],
        },
      ],
  ...
  en: {
    ...
    quickStart: {
      ...
      body: "Choose the one you want to understand most right now.",
      items: [
        {
          ...
          variants: [
            {
              title: "93Q · Quick Version",
              description: "Get a fast read on type preference and decision style.",
            },
            {
              title: "144Q · Deep Version",
              description: "Get a fuller profile of type pattern and tendency structure.",
            },
          ],
        },
        {
          ...
          variants: [
            {
              title: "90Q · Quick Version",
              description: "Scan your five-factor outline quickly.",
            },
            {
              title: "120Q · Full Version",
              description: "Read a fuller trait structure and behavior cues.",
            },
          ],
        },
        {
          title: "IQ Test",
          description: "Get a quick baseline on your cognitive ability profile.",
          href: "/tests/iq-test-intelligence-quotient-assessment/take",
          label: "Start test",
        },
        {
          title: "EQ Test",
          description: "See how you perform in emotional recognition and regulation.",
          href: "/tests/eq-test-emotional-intelligence-assessment/take",
          label: "Start test",
        },
        {
          ...
          variants: [
            {
              title: "Standard",
              description: "Quickly confirm your current emotional baseline.",
            },
            {
              title: "Academic Pro",
              description: "Read depressive and anxiety signals with more depth.",
            },
          ],
        },
      ],
