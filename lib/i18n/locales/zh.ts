  ...
  email: {
    preferences: {
      ...
      fields: {
        marketing_updates: {
          title: "营销更新",
          description: "偶尔接收 FermatMind 的营销邮件与产品公告。",
        },
        report_recovery: {
          title: "报告找回",
          description: "接收帮助你找回报告的恢复与交付邮件。",
        },
        product_updates: {
          title: "产品更新",
          description: "接收重要的 FermatMind 产品与功能更新。",
        },
      },
      ctas: {
        orderLookup: "去订单找回页",
    ...
    unsubscribe: {
      ...
      confirmTitle: "确认退订",
      confirmDescription: "确认后，你将停止接收此链接对应的相关邮件。",
      confirm: "确认退订",
      confirming: "退订中...",
      backToPreferences: "返回偏好设置",
      successTitle: "已退订",
      successDescription: "这条邮件链接已成功退订。",
      invalidTitle: "此链接无效或已过期。",
      invalidDescription: "如果你需要新的报告邮件，请前往订单找回；也可以去帮助中心查看下一步说明。",
