...
locale: en
title: "Sales Manager"
summary: "A practical role profile for sales manager including responsibilities, required skills, salary, and growth path."
industry_slug: business
salary_range: "$55,000 - $180,000 (varies by region and seniority)"
job_outlook: "Demand for sales manager talent remains strong in data-driven organizations."
skills:
