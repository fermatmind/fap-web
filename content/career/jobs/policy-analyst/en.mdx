...
summary: "A practical role profile for policy analyst including responsibilities, required skills, salary, and growth path."
industry_slug: public-service
salary_range: "$55,000 - $180,000 (varies by region and seniority)"
job_outlook: "Demand for policy analyst talent remains strong in data-driven organizations."
skills:
