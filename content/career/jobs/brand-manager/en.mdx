...
locale: en
title: "Brand Manager"
summary: "A practical role profile for brand manager including responsibilities, required skills, salary, and growth path."
industry_slug: design
salary_range: "$55,000 - $180,000 (varies by region and seniority)"
job_outlook: "Demand for brand manager talent remains strong in data-driven organizations."
skills:
