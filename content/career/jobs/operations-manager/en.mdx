...
summary: "A practical role profile for operations manager including responsibilities, required skills, salary, and growth path."
industry_slug: operations
salary_range: "$55,000 - $180,000 (varies by region and seniority)"
job_outlook: "Demand for operations manager talent remains strong in data-driven organizations."
skills:
