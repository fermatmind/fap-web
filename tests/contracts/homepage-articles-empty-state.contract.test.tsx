...
const homeCopy: HomePageContent = {
  ...
  quickStart: {
    ...
    items: [
      ...
      { title: "抑郁焦虑综合症测试", description: "同时查看抑郁与焦虑两个维度", href: "/tests/clinical-depression-anxiety-assessment-professional-edition", label: "开始测试", meta: "学术专业版" },
    ],
  },
  families: {
    kicker: "MORE PATHS",
  ...
  seo: {
    ...
    quickStartListDescription: "首页核心测评入口。",
...
describe("homepage recommended reading empty state", () => {
  it("hides the optional recommended reading section when CMS returns no articles", () => {
    render(<HomePageExperience locale="zh" copy={homeCopy} articles={[]} />);
