...
describe("sitemap indexability contract", () => {
  ...
  it("frontend sitemap config includes approved Career job detail routes and excludes query/search-style Career discovery", async () => {
    ...
    expect(locs).toContain("/zh/help/contact");
    expect(locs).toContain("/zh/help/faq");
    ...
    expect(locs).toContain("/en/privacy");
    expect(locs).toContain("/zh/privacy");
    expect(locs).toContain("/en/support");
    expect(locs).toContain("/zh/support");
    expect(locs).toContain("/en/terms");
    expect(locs).toContain("/zh/terms");
