...
describe("career landing hybrid authority contract", () => {
  it("keeps explicit section-level authority ownership on the landing page", async () => {
    ...
    expect(html).toContain('data-testid="career-pathway-jobs"');
    expect(html).toContain('data-testid="career-pathway-recommendation"');
    expect(html).toContain('data-testid="career-pathway-tests"');
    expect(html).toContain('data-testid="career-quiet-library"');
    expect(html).toContain('data-authority-owner="editorial_support_links"');
    ...
    expect(html).toContain("/en/career/guides");
    expect(html).toContain("/en/career/industries");
    expect(html).toContain("/en/datasets/occupations");
    expect(html).not.toContain("INTJ Career Match");
    expect(html).not.toContain("Data Scientists");
    expect(html).not.toContain("Career family exploration layer");
