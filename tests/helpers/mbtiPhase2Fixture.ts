...
function buildReadContractFixture() {
  return {
    ...
    telemetry_parity_fields: [
      ...
      "adaptive_selection_v1.adaptive_contract_version",
      "adaptive_selection_v1.adaptive_fingerprint",
      "adaptive_selection_v1.selection_rewrite_reason",
      "adaptive_selection_v1.content_feedback_weights",
      "adaptive_selection_v1.action_effect_weights",
      "adaptive_selection_v1.recommendation_effect_weights",
      "adaptive_selection_v1.cta_effect_weights",
      "adaptive_selection_v1.next_best_action_v1.key",
...
export function applyMbtiPhase2Fixture(
  ...
  const adaptiveSelection = {
    version: "mbti.adaptive_selection.v1",
    adaptive_contract_version: "mbti.adaptive_selection.v1",
    adaptive_fingerprint: "fixture-adaptive-fingerprint",
    selection_rewrite_reason: "career_followthrough_loop",
    content_feedback_weights: {
      career: 3,
      growth: 2,
      explainability: -1,
    },
    action_effect_weights: {
      "career.next_step": 5,
      "career.work_experiments": 4,
      "growth.next_actions": 3,
      "growth.watchouts": 1,
    },
    recommendation_effect_weights: {
      career: 4,
      growth: 2,
      explainability: -1,
    },
    cta_effect_weights: {
      career_bridge: 5,
      unlock_full_report: 3,
      share_result: 1,
    },
    next_best_action_v1: {
      key: "work_experiment.theme.name_decision_rule",
      section_key: "career.work_experiments",
      family: "career",
      reason: "career_followthrough_loop",
    },
    adaptive_evidence: {
      user_state: {
        feedback_sentiment: feedbackSentiment,
